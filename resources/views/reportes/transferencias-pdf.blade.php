...
<html>
<head>
    <title>Reporte de Transferencias por Clase - {{ $nombreMes }} {{ $año }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <h1>Reporte de Transferencias por Clase - {{ $nombreMes }} {{ $año }}</h1>
        
        @if($datosPorClase->isEmpty())
            <p>No se encontraron transferencias para el mes seleccionado.</p>
        @else
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    @foreach($datosPorClase as $transferencia)
                        <tr>
                            @foreach ($datosPorClase->groupBy('clase') as $clase => $items)
                                @if($transferencia->clase === $clase)
                                    <td>{{ $transferencia->sexo }}</td>
                                    <td>{{ $transferencia->edad }}</td>
